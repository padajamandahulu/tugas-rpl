        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-10 offset-lg-1">
                    ...
                    <div class="section_subtitle">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Dolorum reprehenderit excepturi veniam odit consequuntur quo, reiciendis aliquam molestias deserunt accusamus vero qui dolor delectus et eaque sit ipsam fugit id.</div>
                </div>
            </div>
            <div class="row">
                <div class="col">
                    <div class="course_search">
                        <form action="#" method="get" class="course_search_form d-flex flex-md-row flex-column align-items-start justify-content-between">
                            <div><input type="search" name="keyword" class="course_input" placeholder="Categories" required="required"></div>
                ...
                <div class="col">
                    ...
                    <div class="courses_slider_container">
                        <div class="owl-carousel owl-theme courses_slider">
                            ...
                            $userEmail = session()->get('email'); // Assuming email is stored in session
                            $userPreferenceModel = new \App\Models\PreferenceModel();
                            $activePreferences = $userPreferenceModel->where('email', $userEmail)->where('is_active', 1)->findAll();
                            if ($activePreferences) {
                                // Fetch and display content for each active preference
                                foreach ($activePreferences as $preference) {
                                    // Assuming you have a model to fetch content based on category
                                    $contentModel = new \App\Models\Content();
                                    $content = $contentModel->where('categories', $preference['category'])->findAll();
                            ...
                            ?>
                                        ...
                                        <div class="owl-item">
                                            <div class="course">
                                                <div class="course_image"><img src="/assets/images/<?= $item['thumbnail'] ?>" alt=""></div>
                                                <div class="course_body">
                                                    <div class="course_header d-flex flex-row align-items-center justify-content-start">
                                                        <div class="course_tag">
                                                            <a href="<?= base_url() ?>pages/category?category=<?= urlencode($item['categories']) ?>">
                                                                <?= $item['categories'] ?>
                                                            </a>
                                                        </div>
                                                    </div>
                                                    <div class="course_title">
                                                        <h3><a href="<?= base_url() ?>pages/courses_detail?tittle=<?= urlencode($item['tittle']) ?>"><?= $item['tittle'] ?></a></h3>
                                                    </div>
...
<div class="join">
    <div class="container">
        <div class="row">
            <div class="col-lg-10 offset-lg-1">
                <div class="section_title text-center">
                    <h2>Tonton Video Lebih Lanjut</h2>
                </div>
            </div>
        </div>
    </div>
...
<div class="join">
    <div class="container">
        <div class="row">
            <div class="col-lg-10 offset-lg-1">
                <div class="section_subtitle">Lorem ipsum dolor sit amet consectetur adipisicing elit. Explicabo sint labore ea alias excepturi, tempore dolorem corrupti culpa. Est nisi omnis quas enim veniam distinctio sint autem officiis temporibus. Corrupti.</div>
            </div>
        </div>
    </div>
